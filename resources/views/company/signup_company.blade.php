                            ...
                            <div class="modal-dialog " id="modal-dialog2">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <div class="row  " id="account_row " style="display:inline-flex">
                                                    <div class=" col-lg-4 col-12 bg-light text-center " id="account_image">
                                                        <a href="login2.html"><img class="image" src="slicing_web/company.svg" class="img-fluid" alt="..." /></a>
                                                        <p>company</p>
                                                    </div>
                                                    <div class="col-lg-4 col-12 bg-light text-center" id="account_image">
            ...
            <div class="row">
                <div class="  col-lg-6 col-12  " id="regis_sec">
                    <div class="formdiv text-center">
                        ...
                        <center>
                            <div class="divsround">
                                <img class="img-fluid" src="slicing_web/add.svg" alt="...">
                                <p>Cover image</p>
                            </div>
                        </center>
                        ...
                        <a href="company_home.html"> <button class="btn btn w-100 pb-3 pt-3 " type="button" id="checkout2">Signup</button></a>
                ...
                <div class=" col-lg-6  col-12" id="regis_sec">
                    <img class="img-fluid" src="slicing_web/signup.svg" id="signup_img" alt="...">
                </div>
            </div>
        </div>
    </section>
