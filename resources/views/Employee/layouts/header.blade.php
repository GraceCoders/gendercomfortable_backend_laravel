        ...
        <div class="container">
            <div class="row ">
                <div class=" col-lg-2 col-12" id="second">
                    <img class="img-fluid" src="{{ asset('assets/slicing_web/logo.svg') }}" class="img-fluid"
                        alt="...">
                </div>
                <div class="col-lg-10 col-12" id="second">
                    <div class="buttons1" style="display:inline-flex">
                        ...
                        @else
                            <img class="img-fluid" src="{{ asset('assets/slicing_web/profile.png') }}"
                                class="img-fluid" id="profilepic" alt="..." id="roundimgs">
                        @endif
                        <div class="btn-group">
                            <button type="button" class="btn btn bg-light dropdown-toggle" id="dropdownMenuButton11"
                                data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                    ...
                                    <div class="modal-heads">
                                        <div class="spacing11">
                                            <h5 class="modal-title" id="exampleModalLabel">Hello,
                                                {{ $user->fisrt_name . ' ' . $user->last_name }}!</h5>
                                ...
                                <div class="spacing">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ url('employee/courses') }}">
                                            <p class="donec1"><img class="img-fluid" class="image"
                                                    src="{{ asset('assets/slicing_web/purchased.svg') }}" alt="...">
                                                &nbsp;Courses</p>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ url('employee/certification') }}">
                                            <p class="donec1"><img class="img-fluid" class="image"
                                                    src="{{ asset('assets/slicing_web/certification.svg') }}"
                                                    alt="..."> &nbsp;Certifications</p>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ url('change_password') }}">
                                            <p class="donec1"><img class="img-fluid" class="image"
                                                    src="{{ asset('assets/slicing_web/card.svg') }}" alt="...">
                                                &nbsp;Change Password</p>
                                        </a>
                                    </li>
                                    <li>
