            ...
            <div class="centers">
                <div class="formdiv6 text-center ">
                    <form method="POST" action="{{route('admin.course.update',$data->id)}}" enctype='multipart/form-data'>
                        ...
                        <div class="form-floating">
                            <input type="text" required maxlength="200" minlength="20" name="description" class="form-control" id="floatingInput" value="{{$data->description}}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" required name="price_per_seat" class="form-control" id="floatingInput" value="{{$data->price_per_seat}}">
