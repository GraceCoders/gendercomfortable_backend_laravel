        ...
        <div class="container">
            <div class="row">
                <div class=" col-lg-2 col-12" id="second">
                    <a href={{url('admin/index')}}> <img class="img-fluid" src="{{asset('assets/slicing_web/logo.svg')}}" class="img-fluid" alt="..."></a>
                </div>
                <div class="col-lg-10 col-12" id="second">
                    <div class="buttons">
                       <a href="{{url('/signup_admin')}}"> <button type="button" class="button1 button1-lg" data-bs-toggle="modal" data-bs-target="#exampleModal51">Get Started</button></a>
                ...
                <div class="  col-lg-6 col-12  " id="regis_sec">
                    <div class="formdiv text-center">
                        ...
                        <form action="{{route('admin.register')}}" method="POST" enctype='multipart/form-data'>
                           @csrf
                            ...
                            <div class="round_div">
                                ...
                                <input type="file" class="form-control" id="floatingInput" name="profile_pic"  required placeholder="name@example.com">
                       ...
                       <button class="btn btn w-100 pb-3 pt-3 " type="submit" id="checkout2">Signup</button>
                        <p class="psw">Already have an account? <a href="{{url('/login')}}">Login</a></p>
                    </div>
                </div>
            </form>
