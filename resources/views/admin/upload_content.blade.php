        ...
        <div class="container text-center ">
            <div class="row">
                <div class="col-lg-2 col-12 "><span>
                        <p class="backsp pt-3"><a href="{{ url('create_course') }}"><img class="img-fluid"
                    ...
                    <div class="centers">
                        ...
                        <div class="formdiv6  text-center " id="formdiv6">
                            ...
                            <div>
                                <div class="add_more" id="add_more">
                                    <div class="lession2">
                                        ...
                                        <div class="form-floating mb-3 ">
                                            <input type="text" name="lession_name[]" required class="form-control" id="floatingInput"
                                        ...
                                        <div class="form-floating  ">
                                            ...
                                            <label for="floatingPassword" id="floatingPassword1">choose file</label> <button
                                                type="button" class="btn btn" id="inner_button"
                                                data-bs-toggle="modal" data-bs-target="#exampleModal52">Select</button>
                                ...
                                <small class="divide_marks pt-3"  id="addmore" class="form-text"> <img class="img-fluid "
                                        src="{{asset('assets/slicing_web/add_more.svg')}}"  onclick="addCode()"  alt="..."> add more</small>
                                <small class="divide_marks1 pt-3" class="form-text"> You need to upload atleast two
                                    lesson for
                                    publishing this course</small>

                                    <button class="btn btn w-100 pb-3 pt-3 "
                                    type="submit" id="checkout2">Done</button>
