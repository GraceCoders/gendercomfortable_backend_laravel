                        ...
                        <div class="formdiv6 text-center ">
                            <form method="POST" action="{{route('admin.add.lession')}}" enctype='multipart/form-data'>
                                ...
                                <small class="uploads" class="form-text">
                                    <h1 class="lession">Lession1</h1>
                                </small>
                                <div class="form-floating mb-3 ">
                                    <input type="text"name="lession_name[]" class="form-control" id="floatingInput"
                                ...
                                <div class="form-floating  ">
                                    ...
                                    <input type="file" name="media[]"> <button
                                        type="button" class="btn btn" id="inner_button" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal52">Select</button>
                                </div>
                                <p id="lession_pera" class="form-text"><small>*You need to upload atleast two lesson
                                        for
                                        publishing this course</small></p>
                                <div>
                                    <small class="uploads" class="form-text">
                                        <h1 class="lession">Lession2</h1>
                                    </small>
                                    <div class="form-floating mb-3 ">
                                        <input type="text" name="lession_name[]" class="form-control" id="floatingInput"
                                            placeholder="name@example.com">
                                ...
                                <div>
                                    <small class="divide_marks pt-3" class="form-text"><img class="img-fluid "
                                            id="addmore" src="{{ asset('assets/slicing_web/add_more.svg') }}" alt="...">
                                        add
                                        more</small>
                                                    ...
                                                    <div class="container text-center">
                                                        ...
                                                        <div class="row  " id="account_row "
                                                            ...
                                                            <div class=" col-lg-4 col-12 bg-light text-center "
                                                                id="account_image">
                                                                <img class="image"
                                                                    src="{{ asset('assets/slicing_web/pdf.svg') }}"
                                                                    class="img-fluid" alt="..." />
                                                            ...
                                                            <div class="col-lg-4 col-12 bg-light text-center"
                                                                id="account_image">
                                                                <img class="image"
                                                                    src="{{ asset('assets/slicing_web/vid.svg') }}"
