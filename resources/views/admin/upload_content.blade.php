        ...
        <div class="container text-center ">
            <div class="row">
                <div class="col-lg-2 col-12 "><span>
                        <p class="backsp pt-3"><a href="{{ url('admin/create_course') }}"><img class="img-fluid"
                                    src="{{ asset('assets/slicing_web/back.svg') }}"> Back</p> </a>
                    </span>
                </div>
                                ...
                                <div>
                                    ...
                                    <div class="lession2">
                                            ...
                                            <div class="form-floating  ">
                                                ...
                                                <button type="button" class="btn btn" id="inner_button"
                                    ...
                                    <small class="divide_marks pt-3" id="addmore" class="form-text"> <img
