                    ...
                    <form method="POST" action="{{ route('admin.add.lession') }}" enctype='multipart/form-data'>
                        ...
                        <div class="formdiv6  text-center " id="formdiv6">
                            ...
                            <div>
                                <div class="add_more" id="add_more">
                                    <div class="lession2">
                                        ...
                                        <div class="form-floating mb-3 ">
                                            <input type="text" name="lession_name[]" required class="form-control" id="floatingInput" placeholder="name@example.com">
                                ...
                                <small class="divide_marks pt-3" id="addmore" class="form-text"> <img class="img-fluid " src="{{ asset('assets/slicing_web/add_more.svg') }}" onclick="addCode()" alt="..."> add more</small>
